...
from framefusion.ablation import FrameFusionAdjacent, FrameFusionRandom, FrameFusionRank
...
def replace_framefusion_forward(
    ...
    print("FrameFusionRank")
    framefusion = FrameFusionRank(merging_ratio_list=[0.35, 0.35, 0.35])
