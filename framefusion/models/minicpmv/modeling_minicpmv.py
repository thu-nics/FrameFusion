...
def get_vllm_embedding(self, data):
    ...
    for i in range(bs):
        ...
        if len(cur_vs_hs) > 0:
            ...
            patch_per_frame = cur_image_bound.shape[0] // num_frames
            token_per_frame = cur_image_bound[patch_per_frame, 0] - cur_image_bound[0, 0]
            patch_type[i, cur_image_bound[0, 0] : (cur_image_bound[-1, 1]+2)] = torch.arange(0, cur_image_bound[-1, 1]-cur_image_bound[0, 0]+2, device=patch_type.device) % token_per_frame
